...
class UnichartTypeDataset(Dataset):
    def __init__(
        self,
        json_path: str,
        images_folder: str,
        ...
        self.chart_type_name_mapping = {'v_bar': 'Bar Plot', 'h_bar': 'Bar Plot', 'line': 'Line Plot', 'pie': 'Pie Plot'}
    ...
    def __getitem__(self, idx: int):
        ...
        chart_type = self.chart_type_name_mapping[chart_type]

        # input_prompt = "<extract_data_table> <s_answer>"
        processed_parse = self.task_prefix + " " + chart_type + " " + self.prompt_end_token + " " + data_table + self.processor.tokenizer.eos_token 
