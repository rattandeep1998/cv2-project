...
csv_file_path = "finetuned_unichart_on_unichart_pretrain_run_on_vistext_updated.csv"
processed_csv_file_path = "finetuned_unichart_on_unichart_pretrain_run_on_vistext_processed.csv"
